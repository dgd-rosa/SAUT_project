...
def simple_path(center_x: float, center_y: float, z: float, vehicle_name: str, speed: float):

    spawn_line([center_x, center_y, z], [center_x+5, center_y, z], [0.0, 0.0, 0.0], vehicle_name, speed)

    spawn_arc([center_x+5, center_y], [center_x+5, center_y-5], [center_x+5, center_y-2.5], 1, z, vehicle_name, speed)

    spawn_line([center_x+5, center_y-5, z], [center_x-5, center_y-5, z], [0.0, 0.0, 0.0], vehicle_name, speed)

    spawn_arc([center_x-5, center_y-5], [center_x-5, center_y-10], [center_x-5, center_y-7.5], -1, z, vehicle_name, speed)
...
def path_big(center_x: float, center_y: float, z: float, vehicle_name: str, speed: float):
    ...
    spawn_line([center_x, center_y, z], [center_x+50, center_y, z], [0.0, 0.0, 0.0], vehicle_name, speed)

    spawn_arc([center_x+50, center_y], [center_x+50, center_y-10], [center_x+50, center_y-5], 1, z, vehicle_name, speed)

    spawn_line([center_x+50, center_y-10, z], [center_x, center_y-10, z], [0.0, 0.0, 0.0], vehicle_name, speed)
